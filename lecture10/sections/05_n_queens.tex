...
\node[font=\tiny,text=red!70!black,below=.5mm of d1]{row2 후보 소진};
\node[font=\tiny,text=red!70!black,below=.5mm of d2]{row3 후보 소진};
\node[font=\tiny]at(0,-4.4){두 solution: \([1,3,0,2]\), \([2,0,3,1]\)};
\node[font=\tiny]at(0,-4.8){표시되지 않은 형제는 promising 검사에서 즉시 기각된 후보다};
\end{tikzpicture}}
\end{frame}
