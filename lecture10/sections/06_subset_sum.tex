...
\node[ssnode]{\(i0,s0,r18\)}
 child{node[ssnode]{\(\{3\},s3,r15\)}
   child{node[ssnode]{\(\{3,4\},s7,r11\)}
     ...
     child{node[font=\footnotesize\bfseries,text=AlgoGray]{\(\cdots\)} edge from parent[dashed]}
   }
...
\node[font=\footnotesize\bfseries,text=red!70!black,below=.8mm of c1]{\(s>W\)};
\node[font=\footnotesize\bfseries,text=red!70!black,below=.8mm of c2]{\(s+r<W\)};
\end{tikzpicture}}
\end{frame}
