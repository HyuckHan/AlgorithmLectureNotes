...
% (Defined inside the picture, not before the frame, because the
% webbook's figure-extraction pipeline only sees this picture's own
% span verbatim -- a \newcommand outside it is invisible there.)
