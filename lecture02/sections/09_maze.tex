...
\only<3|handout:0>{\foreach \r/\c in {0/0,0/1,1/1,2/1,2/2,3/2,4/2}{\gridcell{\r}{\c}{path}}\gridcell{2}{0}{dead}}
\only<4|handout:0>{\foreach \r/\c in {0/0,0/1,1/1,2/1,2/2}{\gridcell{\r}{\c}{path}}\foreach \r/\c in {2/0,3/2,4/2}{\gridcell{\r}{\c}{dead}}}
\only<5|handout:0>{\foreach \r/\c in {0/0,0/1,1/1,2/1,2/2,2/3,3/3}{\gridcell{\r}{\c}{path}}\foreach \r/\c in {2/0,3/2,4/2}{\gridcell{\r}{\c}{dead}}}
\only<6|handout:1>{\foreach \r/\c in {0/0,0/1,1/1,2/1,2/2,2/3,3/3,4/3,4/4,5/4,5/5}{\gridcell{\r}{\c}{path}}\foreach \r/\c in {2/0,3/2,4/2}{\gridcell{\r}{\c}{dead}}}
...
\only<3|handout:0>{\Large 아래쪽 통로로 전진을 시도하는 중}
\only<4|handout:0>{\Large 더 나아갈 수 없어 되돌아가며 지나온 칸을 dead로 표시}
\only<5|handout:0>{\Large 되돌아가 다른 이웃을 탐색}
