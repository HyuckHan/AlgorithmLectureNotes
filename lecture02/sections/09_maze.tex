...
\only<3|handout:0>{\foreach \r/\c in {0/0,0/1,1/1,2/1,2/2,2/3,3/3}{\gridcell{\r}{\c}{path}}\foreach \r/\c in {2/0,3/2,4/2}{\gridcell{\r}{\c}{dead}}}
\only<4|handout:1>{\foreach \r/\c in {0/0,0/1,1/1,2/1,2/2,2/3,3/3,4/3,4/4,5/4,5/5}{\gridcell{\r}{\c}{path}}\foreach \r/\c in {2/0,3/2,4/2}{\gridcell{\r}{\c}{dead}}}
...
\only<3|handout:0>{\Large 되돌아가 다른 이웃을 탐색}
\only<4|handout:1>{\Large 출구까지 한 경로를 발견}
\end{columns}
\end{frame}
