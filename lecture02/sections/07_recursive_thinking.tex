...
\only<1|handout:0>{
  ...
  \node[above=16pt of a3,text=AlgoOrangeText,font=\small\bfseries] {$A[mid]=12<x$};
}
\only<2|handout:0>{
  ...
  \node[below=5pt of a6,font=\small] {$end=6$};
  \node[above=16pt of a5,text=AlgoOrangeText,font=\small\bfseries] {$mid=5:\ A[mid]=23>x$};
}
\only<3|handout:1>{
  ...
  \node[above=16pt of a4,text=AlgoOrangeText,font=\small\bfseries] {$mid=4:\ A[mid]=x$};
}
\end{tikzpicture}
